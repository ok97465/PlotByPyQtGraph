...
def plot_image():
    ...
    imv_gray = imagescpg(
        ...
        data,
        cmap="viridis",
        title="Gray Image with viridis Colormap",
        xlabel="Column",
        ylabel="Row",
        colorbar=True,
    )
    ...
    imv_gray1 = imagescpg(
        data,
        cmap="turbo",
        title="Gray Image with turbo Colormap",
        xlabel="Column",
        ylabel="Row",
        colorbar=False,
    )
    ...
    imv_gray2 = imagescpg(
        ...
        data,
        cmap="jet",
        title="Gray Image with jet Colormap",
        xlabel="Column",
        ylabel="Row",
        colorbar=True,
        style={
...
def plot_1d():
    ...
    fig, ax = plotpg(x, y, title="title", xlabel="xlabel", ylabel="ylabel", name="0")

    for ii in range(1, 7):
        plotpg(x - 500 * ii, y + 500 + ii, name=f"{ii}", ax=ax)
